...
if scatter_button:
    ...
    fig = go.Figure(data=go.Scatter(x=vehic_data['year'], y=vehic_data['odometer'], mode='markers'))

    # Incluir un título al gráfico si lo deseas
    fig.update_layout(title_text='Relación entre Año y Odómetro del Vehículo',
                      xaxis_title='Año',
